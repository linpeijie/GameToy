...
void Boid::setMember()
{
    wanderDistance += direction * 2.f*this->elapsed;
    if (wanderDistance < 0.0f) {wanderDistance = 0.0f;direction *= -1;}
    if (wanderDistance > 50.f) {wanderDistance = 50.0f;direction *= -1;}
}