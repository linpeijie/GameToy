...
{
    if (wanderDirection && wanderDistance < 20.0f) {wanderDistance += 2.0*this->elapsed;} else wanderDirection = false;
    if (!wanderDirection && wanderDistance > -20.0f) {wanderDistance *= -2;} else wanderDirection = true;
